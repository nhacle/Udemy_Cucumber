...
public class TestConfig {
	...
	public static String from = "nguyennhac2904@gmail.com";
	public static String password = "nguyennhac";
	public static String[] to = {
	        /* "seleniumcoaching@gmail.com","trainer@way2automation.com", */ "nguyennhac94@gmail.com" };
